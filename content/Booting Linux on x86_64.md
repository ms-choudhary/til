...
Scans memory map received earlier from the firmware and finds the ranges where everything can fit. It draws random number using the best early entropy source. On modern CPUs, it's `rand` instruction on hardware. [](Trusted%20Platform%20Module%20(TPM)%5D)
...
- [](Booting%20Linux%20on%20x86_64#Microcode%20patching%5D)
...
## Related
- [](Wake%20On%20Lan%20(WOL)%5D)
- [](Booting%20Linux%20on%20x86_64%5D)
- [](Booting%20Linux%20on%20x86_64%5D)
- [](Booting%20Linux%20on%20x86_64%5D)